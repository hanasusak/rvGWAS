...
# snp.file.name <- '/users/project/PanCanRisk_005555_no_backup/PCAWG/Germline_Variant_Calling/BROAD/MERGED/PASS_files/chr_19_20_21_22/chr19_to_chr22.exonic.PASS.sorted.annotated.parsed.QC_GQ.csv'
# snp.file.name <- '/users/project/PanCanRisk_005555_no_backup/PCAWG/Germline_Variant_Calling/BROAD/MERGED/PASS_files/chr_19_20_21_22/chr19_to_chr22.PASS.sorted.annotated.parsed.QC_GQ.OK.csv'
# samples.info.file <-'/users/project/PanCanRisk_005555_no_backup/PCAWG/Data_info/samples_info_January_16_2017.txt'
...
if(answ=='y' & TRUE ){
   ...
   mut2.cases <- aggregate(.~AGG, data=mut.cases, sum)
   #mut.all.controls <- as.data.table(mut.all.controls)
   mut2.contr <- aggregate(.~AGG, data=mut.contr, sum) 
